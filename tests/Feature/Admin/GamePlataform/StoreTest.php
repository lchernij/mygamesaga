...
class StoreTest extends TestCase
{
    ...
    public function test_game_plataform_store_action_can_not_be_access_when_guess()
    {
        Auth::logout();

        $response = $this->post('/hq/game-plataforms');
     ...
     */
    public function test_game_plataform_store_action_validation_fields($payload, $expected)
    {
    ...
    public function test_game_plataform_store_action_validation_fields_unique()
    {
     ...
     */
    public function test_game_plataform_store_action_create_valid_register($payload, $expected)
    {
        $response = $this->post('/hq/game-plataforms', $payload);
    ...
    /**
     * Provider from test_game_plataform_store_action_validation_fields
     */
